...
open class AccountsRecord() : UpdatableRecordImpl<AccountsRecord>(Accounts.ACCOUNTS), Record5<Long?, String?, String?, Int?, Long?> {
    ...
    override fun valuesRow(): Row5<Long?, String?, String?, Int?, Long?> = super.valuesRow() as Row5<Long?, String?, String?, Int?, Long?>
    ...
    override fun field5(): Field<Long?> = Accounts.ACCOUNTS.USER_ID
    ...
    override fun value5(value: Long?): AccountsRecord {
        this.userId = value
        return this
    }

    override fun values(value1: Long?, value2: String?, value3: String?, value4: Int?, value5: Long?): AccountsRecord {
        this.value1(value1)
        this.value2(value2)
        this.value3(value3)
        this.value4(value4)
     ...
     */
    constructor(id: Long? = null, code: String? = null, name: String? = null, elementType: Int? = null, userId: Long? = null): this() {
        this.id = id
        this.code = code
        this.name = name
